...
(() => {
  ...
  // src/constants.ts
  var NODE_SUFFIX, CDN_URL, SPEEDTEST_URL, PROXY_GROUPS, countriesMeta;
  ...
  var AI_PREFERRED_NODES, AI_HK_FALLBACK_NODES;
  var init_proxy_groups = __esm({
    "src/proxy_groups.ts"() {
      ...
      AI_HK_FALLBACK_NODES = ["HK-HKG-Dmit1-VLRV-dllxr1", "HK-HKG-HH1-VLRV-dllxr1"];
    }
  });
